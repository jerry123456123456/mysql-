...
int main()
{
    ...
    loader.AddDatabase(SakilaDatabase, "192.168.186.138;3306;root;123456;sakila",
        8, 2);
    ...
    {
         SakilaDatabase.DirectExecute("insert into actor(actor_id,first_name, last_name) values (1,'mark', '0voice')");
